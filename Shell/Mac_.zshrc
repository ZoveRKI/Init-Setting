...
# typeset -g POWERLEVEL9K_INSTANT_PROMPT=offß
# source /opt/homebrew/share/powerlevel10k/powerlevel10k.zsh-theme
# To customize prompt, run `p10k configure` or edit ~/.p10k.zsh.
# [[ ! -f ~/.p10k.zsh ]] || source ~/.p10k.zsh

# # 自定义 Powerlevel10k 提示符结尾加上换行符
# function powerlevel10k_custom_prompt() {
#   p10k prompt
#   echo ""
# }
# # 重定义 Powerlevel10k 的prompt命令
# functions[prompt]=powerlevel10k_custom_prompt
